...
const ICancellationToken_1 = require("./ICancellationToken");
const EventEmitter_1 = require("./lib/EventEmitter");
const Messages_1 = require("./Messages");
class USBDriver extends EventEmitter_1.EventEmitter {
    constructor(vendorId, productId) {
        ...
        this.usedChannels = 0;
        this.readInCancellationToken = new ICancellationToken_1.CancellationToken();
        this.maxChannels = 0;
        this.canScan = false;
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const readInEndPoint = () => __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    ...
                    if (!(error instanceof ICancellationToken_1.CancellationError)) {
                        throw error;
                    }
                }
            });
    ...
    reset() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.maxChannels = 0;
            this.usedChannels = 0;
            yield this.write(Messages_1.Messages.resetSystem());
        });
    }
    isScanning() {
    ...
    read(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (messageID === Constants_1.Constants.MESSAGE_STARTUP) {
                yield this.write(Messages_1.Messages.requestMessage(0, Constants_1.Constants.MESSAGE_CAPABILITIES));
            }
            else if (messageID === Constants_1.Constants.MESSAGE_CAPABILITIES) {
                this.maxChannels = data.getUint8(3);
                this.canScan = (data.getUint8(7) & 0x06) === 0x06;
                yield this.write(Messages_1.Messages.setNetworkKey());
            }
            else if (messageID === Constants_1.Constants.MESSAGE_CHANNEL_EVENT &&
                data.getUint8(4) === Constants_1.Constants.MESSAGE_NETWORK_KEY) {
