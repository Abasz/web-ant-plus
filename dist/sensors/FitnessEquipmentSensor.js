...
exports.FitnessEquipmentSensor = void 0;
const UpdateState_1 = require("../lib/UpdateState");
const Messages_1 = require("../Messages");
const AntPlusSensor_1 = require("./AntPlusSensor");
const FitnessEquipmentSensorState_1 = require("./FitnessEquipmentSensorState");
class FitnessEquipmentSensor extends AntPlusSensor_1.AntPlusSensor {
    attachSensor(channel, deviceID) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.state = new FitnessEquipmentSensorState_1.FitnessEquipmentSensorState(deviceID);
        });
    }
    updateState(deviceId, data) {
        ...
        (0, UpdateState_1.updateFitnessEquipmentSensorState)(this, this.state, data);
    }
