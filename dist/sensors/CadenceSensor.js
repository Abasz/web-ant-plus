...
exports.CadenceSensor = void 0;
const UpdateState_1 = require("../lib/UpdateState");
const AntPlusSensor_1 = require("./AntPlusSensor");
const CadenceSensorState_1 = require("./CadenceSensorState");
class CadenceSensor extends AntPlusSensor_1.AntPlusSensor {
    constructor() {
        super(...arguments);
    ...
    attachSensor(channel, deviceID) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.state = new CadenceSensorState_1.CadenceSensorState(deviceID);
        });
    }
    updateState(deviceId, data) {
        ...
        (0, UpdateState_1.updateCadenceSensorState)(this, this.state, data);
    }
}
