    ...
    updateState(data) {
        ...
        switch (page) {
            case 0x01: {
                ...
                const previous = (data.getUint16(Messages.BUFFER_INDEX_MSG_DATA + 5, true) >> 4) &
                    0x3ff;
                const current = (data.getUint16(Messages.BUFFER_INDEX_MSG_DATA + 6, true) >> 6) &
                    0x3ff;
            ...
            case 0x50: {
                ...
                this.ModelNum = data.getUint16(Messages.BUFFER_INDEX_MSG_DATA + 6, true);
                break;
            }
            case 0x51: {
            ...
            case 0x52: {
                ...
                const batteryFrac = data.getInt32(Messages.BUFFER_INDEX_MSG_DATA + 6, true);
                const batteryStatus = data.getInt32(Messages.BUFFER_INDEX_MSG_DATA + 7, true);
                this.OperatingTime =
