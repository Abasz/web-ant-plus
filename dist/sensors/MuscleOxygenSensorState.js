...
exports.MuscleOxygenSensorState = void 0;
    ...
    updateState(data) {
        ...
        switch (page) {
            case 0x01: {
                ...
                const notifications = data.getUint8(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 2);
                const capabilities = data.getUint16(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 3, true);
                const total = data.getUint16(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 4, true) & 0xfff;
                const previous = (data.getUint16(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 5, true) >> 4) &
                    0x3ff;
                const current = (data.getUint16(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 6, true) >> 6) &
                    0x3ff;
            ...
            case 0x52: {
                this.BatteryId = data.getUint8(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 2);
                const operatingTime = data.getUint32(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 3, true) & 0xffffff;
                const batteryFrac = data.getInt32(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 6, true);
                const batteryStatus = data.getInt32(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 7, true);
                this.OperatingTime =
...
exports.MuscleOxygenSensorState = MuscleOxygenSensorState;
