...
class FitnessEquipmentSensorState {
    ...
    updateState(data) {
        ...
        switch (page) {
            case 0x01: {
                const temperature = data.getUint8(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 3);
                if (temperature !== 0xff) {
                    this.Temperature = -25 + temperature * 0.5;
                }
                const calBF = data.getUint8(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 1);
                if (calBF & 0x40) {
                    this.ZeroOffset = data.getUint16(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 4, true);
                }
                if (calBF & 0x80) {
                    this.SpinDownTime = data.getUint16(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 6, true);
                }
                break;
            }
            case 0x10: {
                const equipmentTypeBF = data.getUint8(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 1);
                ...
                let elapsedTime = data.getUint8(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 2);
                let distance = data.getUint8(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 3);
                const speed = data.getUint16(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 4, true);
                const heartRate = data.getUint8(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 6);
                const capStateBF = data.getUint8(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 7);
                if (heartRate !== 0xff) {
            ...
            case 0x11: {
                const cycleLen = data.getUint8(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 3);
                const incline = data.getInt16(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 4, true);
                const resistance = data.getUint8(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 6);
                const capStateBF = data.getUint8(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 7);
                if (cycleLen !== 0xff) {
            ...
            case 0x12: {
                const mets = data.getUint16(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 2, true);
                const caloricbr = data.getUint16(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 4, true);
                const calories = data.getUint8(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 6);
                const capStateBF = data.getUint8(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 7);
                if (mets !== 0xffff) {
                    this.METs = mets / 100;
                }
            ...
            case 0x13: {
                const cadence = data.getUint8(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 4);
                let negDistance = data.getUint8(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 5);
                let posDistance = data.getUint8(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 6);
                const flagStateBF = data.getUint8(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 7);
                if (cadence !== 0xff) {
            ...
            case 0x14: {
                let posDistance = data.getUint8(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 2);
                let strides = data.getUint8(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 3);
                const cadence = data.getUint8(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 4);
                const power = data.getUint16(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 5, true);
                const flagStateBF = data.getUint8(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 7);
                if (cadence !== 0xff) {
                    this.Cadence = cadence;
                }
            ...
            case 0x16: {
                let strokes = data.getUint8(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 3);
                const cadence = data.getUint8(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 4);
                const power = data.getUint16(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 5, true);
                const flagStateBF = data.getUint8(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 7);
                if (cadence !== 0xff) {
            ...
            case 0x19: {
                ...
                const cadence = data.getUint8(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 2);
                let accPower = data.getUint16(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 3, true);
                const power = data.getUint16(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 5, true) & 0xfff;
                const trainerStatus = data.getUint8(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 6) >> 4;
                const flagStateBF = data.getUint8(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 7);
            ...
            case 0x1a: {
                ...
                let eventCount = data.getUint8(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 1);
                let wheelTicks = data.getUint8(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 2);
                let accWheelPeriod = data.getUint16(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 3, true);
                let accTorque = data.getUint16(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 5, true);
                const flagStateBF = data.getUint8(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 7);
                if (eventCount !== oldEventCount) {
            ...
            case 0x50: {
                this.HwVersion = data.getUint8(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 3);
                this.ManId = data.getUint16(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 4, true);
                this.ModelNum = data.getUint16(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 6, true);
                break;
            }
            case 0x51: {
                const swRevSup = data.getUint8(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 2);
                const swRevMain = data.getUint8(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 3);
                const serial = data.getInt32(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 4, true);
            ...
            case 0x56: {
                const idx = data.getUint8(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 1);
                const tot = data.getUint8(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 2);
                const chState = data.getUint8(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 3);
                const devId = data.getUint16(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 4, true);
                const trType = data.getUint8(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 6);
                const devType = data.getUint8(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 7);
                if (idx === 0) {
                    this.PairedDevices = [];
                }
                if (tot > 0) {
