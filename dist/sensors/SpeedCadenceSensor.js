...
exports.SpeedCadenceSensor = void 0;
const UpdateState_1 = require("../lib/UpdateState");
const AntPlusSensor_1 = require("./AntPlusSensor");
const SpeedCadenceSensorState_1 = require("./SpeedCadenceSensorState");
class SpeedCadenceSensor extends AntPlusSensor_1.AntPlusSensor {
    constructor() {
        super(...arguments);
    ...
    attachSensor(channel, deviceID) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.state = new SpeedCadenceSensorState_1.SpeedCadenceSensorState(deviceID);
        });
    }
    updateState(deviceId, data) {
        ...
        (0, UpdateState_1.updateSpeedCadenceSensorState)(this, this.state, data);
    }
}
