...
class SpeedCadenceSensorState {
    ...
    updateState(data, wheelCircumference) {
        ...
        let cadenceTime = data.getUint16(Messages_1.Messages.BUFFER_INDEX_MSG_DATA, false);
        let cadenceCount = data.getUint16(Messages_1.Messages.BUFFER_INDEX_MSG_DATA + 2, true);
        ...
        return {
            updatedState: this,
            resultType: cadenceDataChanged && speedDataChanged
                ? "both"
                : cadenceDataChanged
                    ? "cadence"
                    : speedDataChanged
