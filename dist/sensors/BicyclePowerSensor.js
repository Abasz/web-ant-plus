...
exports.BicyclePowerSensor = void 0;
const UpdateState_1 = require("../lib/UpdateState");
const AntPlusSensor_1 = require("./AntPlusSensor");
const BicyclePowerSensorState_1 = require("./BicyclePowerSensorState");
class BicyclePowerSensor extends AntPlusSensor_1.AntPlusSensor {
    attachSensor(channel, deviceID) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.state = new BicyclePowerSensorState_1.BicyclePowerSensorState(deviceID);
        });
    }
    updateState(deviceId, data) {
        ...
        (0, UpdateState_1.updateBicyclePowerSensorState)(this, this.state, data);
    }
}
